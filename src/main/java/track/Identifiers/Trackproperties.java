...
public class Trackproperties extends AbstractEuclideanSpace implements RealLocalizable, Comparable<Trackproperties> {
	...
	/** A user-supplied name for this filament. */
	private String name;
	...
	/**
	 * Stores the specified feature value for this filament.
	 *
	 * @param feature
